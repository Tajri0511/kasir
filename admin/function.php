...
$conn = mysqli_connect("localhost", "root", "", "webkasir");
...
function add_produk($add_produk)
{
    ...
    // cek apakah nama_kategori ada dalam tabel kategori
        ...
        // query insert data
        $query = "INSERT INTO produk (nama_barang, stok, harga_jual, harga_beli) VALUES ('$nama_barang', '$stok', '$harga_jual', '$harga_beli')";
        mysqli_query($conn, $query);
