...
<div class="row">
  ...
  <div class="col-lg-3">            
  <input name="filter" class="btn btn-success" type="submit" value="Tampilkan" />
  </div>      
</div>
</form>
<br>
...
<div class="row">
  <div class="col-lg-3">
    <a href="../admin/module/nota/pdf.php" target="_blank" class="btn btn-primary"><i class="bi bi-filetype-pdf mr-2"></i>  Cetak Laporan PDF</a>
   </div>
</div>
<div class="row mt-3">
  <div class="col-lg-12">
    <a href="../admin/module/nota/export_excel.php" target="_blank" class="btn btn-primary"><i class="bi bi-file-earmark-excel mr-2"></i>  Cetak Laporan EXCEL</a>
   </div>
</div>                