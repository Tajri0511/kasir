            ...
            <div class="card mb-4">
                <div class="card-header py-3">
                    ...
                    <form method="POST" action="">
                        ...
                        <br>
                        <input type="submit" name="beli" value="Bayar" class="btn btn-primary btn-sm mt-3 mr-3 w-25">
                        <button name="clear" value="Clear" class="btn btn-primary btn-sm mt-3 w-25">Clear
                        </button>
                    </form>
                </div>
            </div>
